...
excluded=(. .. .git .gitmodules bootstrap.sh Gemfile Gemfile.lock Rakefile README.md)
...
if [ -d $HOME/.dotfiles ]; then
  ...
  # Clone Repo
  notice "Downloading"
  git clone --recursive https://github.com/tomfuertes/gf3dotfiles.git $HOME/.dotfiles
